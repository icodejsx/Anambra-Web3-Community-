    ...
    <div className="pt-20">
      ...
      <section className="relative py-28 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-white/55 font-dm text-xl max-w-xl mx-auto stagger-child">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                  ...
                  return (
                    <a key={opt.title} href={opt.href} target={opt.href.startsWith("http") ? "_blank" : undefined} rel="noopener noreferrer"
                      ...
                      <div>
                        ...
                        <div className="text-white/35 font-dm text-xs mb-1">{opt.desc}</div>
                        <div className="text-primary font-mono text-xs">{opt.value}</div>
                      </div>
                    </a>
                  );
                })}
              ...
              <div className="glass rounded-2xl p-6">
                ...
                <div className="space-y-2">
                  {["Sponsor a Conference or Program","Speak at an Event","Partner with the Community","Host a Workshop or Bootcamp","Feature Your Web3 Opportunity","Media & Press Inquiries"].map(item=>(
                    <div key={item} className="flex items-center gap-2 text-white/50 font-dm text-sm hover:text-white/70 transition-colors">
            ...
            <div className="scale-reveal" style={{transitionDelay:"0.15s"}}>
              <div className="glass shimmer rounded-3xl p-8">
                ...
                <p className="text-white/40 font-dm text-sm mb-8">We respond within 24–48 hours.</p>
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-white/45 font-dm text-xs mb-2 uppercase tracking-wider">First Name</label>
                      <input type="text" placeholder="First name" className="w-full bg-white/3 border border-primary/15 rounded-xl px-4 py-3 text-white font-dm text-sm placeholder-white/20 focus:outline-none focus:border-primary/50 transition-colors" />
                    </div>
                    <div>
                      <label className="block text-white/45 font-dm text-xs mb-2 uppercase tracking-wider">Last Name</label>
                      <input type="text" placeholder="Last name" className="w-full bg-white/3 border border-primary/15 rounded-xl px-4 py-3 text-white font-dm text-sm placeholder-white/20 focus:outline-none focus:border-primary/50 transition-colors" />
                    </div>
                  </div>
                  <div>
                    <label className="block text-white/45 font-dm text-xs mb-2 uppercase tracking-wider">Email</label>
                    <input type="email" placeholder="you@example.com" className="w-full bg-white/3 border border-primary/15 rounded-xl px-4 py-3 text-white font-dm text-sm placeholder-white/20 focus:outline-none focus:border-primary/50 transition-colors" />
                  </div>
                  <div>
                    <label className="block text-white/45 font-dm text-xs mb-2 uppercase tracking-wider">Reason</label>
                    <select className="w-full bg-[#010147] border border-primary/15 rounded-xl px-4 py-3 text-white/60 font-dm text-sm focus:outline-none focus:border-primary/50 transition-colors">
                  ...
                  <div>
                    <label className="block text-white/45 font-dm text-xs mb-2 uppercase tracking-wider">Message</label>
                    <textarea rows={5} placeholder="Tell us more..." className="w-full bg-white/3 border border-primary/15 rounded-xl px-4 py-3 text-white font-dm text-sm placeholder-white/20 focus:outline-none focus:border-primary/50 transition-colors resize-none" />
                  </div>
