    ...
    <div className="pt-20">
            ...
            {teamMembers.map((member, i) => (
              ...
              >
                ...
                <div className="img-hover h-96 overflow-hidden relative">
                  ...
                  {member.featured && (
                    <div className="absolute top-4 right-4 px-2.5 py-1 bg-primary text-dark text-xs font-mono font-bold rounded-full">
                      ★ Co-Founder
                    </div>
                  )}
                </div>
                ...
                <div className="p-6">
                  ...
                  <div className="text-primary font-mono text-xs uppercase tracking-widest mb-3">{member.role}</div>
                  <p className="text-white/45 font-dm text-sm leading-relaxed mb-5">{member.bio}</p>
      ...
      <section className="py-24 border-t border-primary/10">
        <div className="max-w-3xl mx-auto px-4 text-center scale-reveal">
          ...
          <p className="text-white/55 font-dm mb-8">We&apos;re always looking for passionate builders, educators, and community leaders to help grow the Anambra Web3 ecosystem.</p>
